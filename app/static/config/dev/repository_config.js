...
// Dynamic legend text
const eqLabel = [
  `USGS Earthquake Catalog¹ (M≥${minMag}, ${startYear}–Present), Circle Size ∝ Magnitude`,
];
...
// Auxiliary data.
const auxData = [
  "https://raw.githubusercontent.com/cascadiaquakes/crescent-cfm/dev/crescent_cfm_files/cascadia_subduction_interface_temp.geojson",
...
const auxLabel = [
  "Cascadia subduction interface - Graham et al., 2018",
  "Cascadia plate boundary - Carbotte et al., 2024",
  "Cascadia plate boundary - McCrory et al., 2012.",
  "Cascadia plate boundary from Slab2 - Hayes et al., 2018",
];
const auxColor = [
  Cesium.Color.OLIVE.withAlpha(0.7),
  Cesium.Color.SIENNA.withAlpha(0.7),
  Cesium.Color.SANDYBROWN.withAlpha(0.7),
...
// CFM data
// "/static/geojson/crescent_cfm_crustal_3d.geojson"
// "https://raw.githubusercontent.com/cascadiaquakes/crescent-cfm/dev/crescent_cfm_files/crescent_cfm_crustal_3d.geojson",
const cfmData = [
  "https://raw.githubusercontent.com/cascadiaquakes/crescent-cfm/dev/crescent_cfm_files/crescent_cfm_crustal_3d.geojson",
];
...
// CFM Trace data
const cfmTraceData = [
  "https://raw.githubusercontent.com/cascadiaquakes/crescent-cfm/dev/crescent_cfm_files/crescent_cfm_crustal_traces.geojson",
];
...
// Metadata
const cfmMetadata =
  "https://raw.githubusercontent.com/cascadiaquakes/crescent-cfm/dev/misc_data/metadata/cfm_metadata.csv";

// USGS QFF faults
const cfmUsgsQffData = [
  "https://raw.githubusercontent.com/cascadiaquakes/crescent-cfm/dev/misc_data/USGSQFFD_pnwextract.geojson",
];
const cfmUsgsQffLabel = [
  "USGS Quaternary Fault and Fold Database: Pacific Northwest",
];
const cfmUsgsQffColor = [Cesium.Color.CHOCOLATE];
const ccfmUsgsQffFillOpacity = [0.5];
const ccfmUsgsQffLineWidth = [2];
const cfmUsgsQffTraceMarker = ["line"];
...
if (
  ...
  console.log(
    "Cesium access token not set or is using the placeholder token. Retrieving from server..." +
      Cesium.Ion.defaultAccessToken,
  );
